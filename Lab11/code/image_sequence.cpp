...
namespace csis3700 {
  ...
  ALLEGRO_BITMAP *image_sequence::get_current_image() const {
    return images[current].image;
  }


  void image_sequence::update_current_image(double time) {
